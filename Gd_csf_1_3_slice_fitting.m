...
together = readtable([folder filename no '.xlsx'], 'ReadVariableNames', true, 'Sheet', 'together');
...
x = [repmat(10, 6, 1); repmat(20, 6, 1); repmat(30, 6, 1)];
...
mdl = fitnlm(x,MH,model,beta0, 'Exclude',[5,15]);
